  ...
  const remaining =
    deckMax !== undefined
      ? Math.max(
          ...
          deckMax -
            values.reduce(
              (sum, v, i) => (i === activePlayerIdx ? sum : sum + v),
              0,
            ),
        )
      : undefined;
        ...
        <Pressable style={styles.card} onPress={(e) => e.stopPropagation()}>
                ...
                >
                  <Text
                    style={[
                      ...
                      isActive && styles.playerTabTextActive,
                      disabled && styles.playerTabTextDisabled,
                    ]}
                    numberOfLines={1}
                  >
                    {player.name}
                  ...
                  <Text
                    style={[
                      ...
                      isActive && styles.playerTabValueActive,
                      disabled && styles.playerTabTextDisabled,
                    ]}
                  >
          ...
          {scoringHint && (
            <View style={styles.scoringHintBox}>
              <Text style={styles.scoringHintText}>{scoringHint}</Text>
            </View>
          )}
          ...
          {isOverLimit && (
            <View style={styles.overLimitBanner}>
              <Text style={styles.overLimitText}>
                ⚠ Total ({totalAllocated}) exceeds deck limit ({deckMax})
              </Text>
            </View>
          )}
          <View style={[styles.grid, { width: GRID_WIDTH }]}>
            {buttons.map((n) => {
              const isSelected = n === (values[activePlayerIdx] ?? 0);
              ...
              return (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    isBeyondRemaining && !isSelected && styles.buttonWarning,
                  ]}
              ...
              <View style={styles.multiplierOptions}>
                <TouchableOpacity
                  style={[
                    ...
                    multiplierHolder === -1 && styles.multiplierOptionActive,
                  ]}
                ...
                {players.map((player, idx) => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.multiplierOption,
                      multiplierHolder === idx && styles.multiplierOptionActive,
                    ]}
